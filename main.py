...
class InspectionGUI:
    ...
    def _populate_camera_list(self):
        ...
        # Mock camera doesn't need camera selection
    ...
    def _toggle_connection(self):
        ...
        try:
            if self.motion.is_connected:
                ...
                # Mock camera doesn't use device index
                pass
                ...
                self.motion.connect()
                self.camera.open()
                self._log(f"✓ Connected to {port} and opened mock camera")
    ...
    def _update_preview(self):
        ...
        # Mock camera doesn't provide live frames - show placeholder
        self.preview_label.config(image='', text='Mock Camera Active\n(No Live Preview)', fg='yellow')
